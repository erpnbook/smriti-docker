...
**COMM-06 Objection Handling Guide**
**Location**: `docs/comm/COMM-06_objection_handling.md`

**Reason**: PSV-COMM-001 commercialization sprint consolidated all sales assets into the /comm directory.
