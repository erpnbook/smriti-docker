...
API access is restricted inside [cge_api.py](file:///d:/Smriti_Retail_OS/apps/smriti_retail_os/smriti_retail_os/cge/api/cge_api.py) using the active user's roles.
...
Regardless of RBAC write permissions, database-level changes to [smriti_wallet_ledger.json](file:///d:/Smriti_Retail_OS/apps/smriti_retail_os/smriti_retail_os/smriti_retail_os/doctype/smriti_wallet_ledger/smriti_wallet_ledger.json) records are blocked:
