---
Document ID: "USER-015"
Title: "Psv Leave Behind"
...
**PSV Executive One-Pager**
**Location**: `docs/psv_executive_one_pager.md`

**Reason**: Executive leave-behind created as standalone one-pager with visible ROI assumptions.
