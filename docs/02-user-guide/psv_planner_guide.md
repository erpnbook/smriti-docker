...
| :--- | :---: | :--- | :--- |
| **Green Zone** | 7 – 14 Weeks | **Healthy**: Stock level is optimized. | Maintain normal supply. No expedited action. |
| **Watch Zone** | 3 – 7 Weeks | **Warning**: Stock is depletion-prone. | Queue next shipment; check transit times. |
...
### 2. Worked Scenario
*   ** मुंबई Depot**: Holds 250 excess units of sneaker Style-A (WOC = 30 weeks).
*   **पुणे Depot**: Reports 0 units in stock (WOC = 0 weeks) with a customer demand of 20 units/week.
...
#### Worked Example:
A distributor holds ₹40,00,000 in stock.
*   Active inventory: ₹28,00,000
*   Dead stock (aging over 90 days): ₹12,00,000
